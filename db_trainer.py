...
class db_trainer:
    ...
    def sanitizelogfile_db(self, logfile):
        ...
        tm = Word2Vec(iter=1, min_count=1)
    ...
    def featurizeLF_testing(self, w2v_dictionary, words_to_write=10):
        ...
        for word in most_frequent_words:
            a = model[word]
            features.extend(a[0:4])
            b = model.most_similar(word)
            c = model[b[0][0]]
            features.extend(c[0:3])

        kwids, countids = self.dbwriter.getdictionarykeywordsbyid(most_frequent_words, words_to_write)
        features.extend(self.count_to_tf(countids))

        features = np.asarray(features).astype(float).tolist()
        return features
    ...
    def trainLFfeatures(self):
        ...
        # lf_nn.partial_fit(features, targetoutputs, classes=[1, 2, 3])
        ...
        path_to_save_kmeans = 'C:/Users/Sourabh/Documents/logpredict/logpredict/logpredict/nb_models/km'
    ...
    def trainLFfeatures_BRBM(self):
        ...
        self.saveclassifier(path='C:/Users/Sourabh/Documents/logpredict/logpredict/logpredict/nb_models/rbm',
    ...
    def testLFfeatures(self, queue):
        ...
        path_to_saved_models = 'C:/Users/Sourabh/Documents/logpredict/logpredict/logpredict/nb_models/'
